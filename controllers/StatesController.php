...
class StatesController extends Controller
{
            ...
            [
                'verbs' => [
                    ...
                    'access' => [
                        ...
                        'only' => ['create', 'update', 'delete', 'view', 'index', 'activate'],
                        'rules' => [
                            [
                                'actions' => ['create', 'update', 'delete', 'view', 'index', 'activate'],
                                'allow' => true,
                                'roles' => ['@'],
                            ],
                        ],
    ...
    public function actionDelete($id)
    {
        ...
        $model->is_deleted = 1;
        $model->save(false);
        \Yii::$app->session->setFlash('success', 'State Successfully Deleted');
    ...
    {
        if (($model = States::findOne(['id' => $id])) !== null) {
            return $model;
        }
