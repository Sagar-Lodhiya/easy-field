    ...
    <div id="page-container" <?php if ($page_classes) {
                ...
                <div class="sidebar-content">
                    <div class="chat-talk display-none">
                        ...
                        <div class="chat-talk-info sidebar-section">
                            ...
                            <img src="<?= Url::base(true) ?>/theme/img/placeholders/avatars/avatar5.jpg" alt="avatar" class="img-circle pull-left">
        ...
        <div id="sidebar">
            ...
            <div id="sidebar-scroll">
                ...
                <div class="sidebar-content">
                    <!-- Brand -->
                    <a href="<?= \yii\helpers\BaseUrl::home() ?>" class="sidebar-brand text-center text-uppercase"  style="background-color:rgb(255, 255, 255);height: 70px;">
                        <span class="sidebar-nav-mini-hide"><strong style="font-size: small;"><img height="70px" src="theme/img/logo.png" alt="" srcset=""></strong></span>
                    </a>
                    <!-- END Brand -->
                    ...
                    <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                        <div class="sidebar-user-avatar">
                            <a href="page_ready_user_profile.php">
                                <img src="<?= Url::base(true) ?>/theme/img/placeholders/avatars/avatar2.jpg" alt="avatar">
                            </a>
                        </div>
                        ...
                        <div class="sidebar-user-links">
                            ...
                            <a href="#">
                                ...
                                <?= Html::submitButton('<i class="gi gi-exit"></i> Logout', ['class' => 'btn btn-xs btn-primary']) ?>
                                <?= Html::endForm() ?>
                            </a>
                        </div>
                    </div>
                    ...
                    <?php if ($primary_nav) { ?>
                        ...
                        <ul class="sidebar-nav">
                            <?php foreach ($primary_nav as $key => $link) {
                                ...
                                $active     = (isset($link['url']) && ($template['active_page'] == basename($link['url']))) ? ' active' : '';
                                $icon       = (isset($link['icon']) && $link['icon']) ? '<i class="' . $link['icon'] . ' sidebar-nav-icon"></i>' : '';
                                $visible    = $link['visible'];
                                
                                // Check if the link has a submenu
                                if ($visible) {
                                    if (isset($link['sub']) && $link['sub'] && $visible) {
                                        // print_r($link['sub']);exit;
                                        ...
                                        foreach ($link['sub'] as $sub_link) {
                                            // Check if current submenu item is active
                                            if (isset($sub_link['url']) && ($template['active_page'] == basename($sub_link['url']))) {
                                            ...
                                            if (isset($sub_link['sub']) && $sub_link['sub']) {
                                                foreach ($sub_link['sub'] as $sub2_link) {
                                                    if (isset($sub2_link['url']) && ($template['active_page'] == basename($sub2_link['url']))) {
                                                        $li_active = ' class="active"';
                                                        break;
                                                    }
                                                }
                            ...
                            ?>
                                    ...
                                    ?>
                                        ...
                                        $active     = (isset($sub_link['url']) && ($template['active_page'] == basename($sub_link['url']))) ? ' active' : '';
                                                    ...
                                                    ?>
                                                        ...
                                                        $active = (isset($sub2_link['url']) && ($template['active_page'] == basename($sub2_link['url']))) ? ' class="active"' : '';
                                                                    ?>
                                                                        <li>
