...
var App = (function () {
  ...
  var handleNav = function () {
    ...
    menuLinks.click(function () {
      ...
      if (
        page.hasClass("sidebar-mini") &&
        page.hasClass("sidebar-visible-lg-mini") &&
        getWindowWidth() > 991
      ) {
        ...
        if (link.hasClass("open")) {
          ...
          setTimeout(
            resizePageContent,
            upSpeed > downSpeed ? upSpeed : downSpeed
          );
        }
      }
  ...
  var handlePageScroll = function (sElem, sHeightDiff, sSpeed) {
    if (!page.hasClass("disable-menu-autoscroll")) {
      ...
      if (
        ...
        elemScrollToHeight =
          elemOffsetTop - sHeightDiff > 0 ? elemOffsetTop - sHeightDiff : 0;
        ...
        var elemOffsetCon =
          sElem.offset().top +
          Math.abs($("div:first", sContainer).offset().top);

        elemScrollToHeight =
          elemOffsetCon - sHeightDiff > 0 ? elemOffsetCon - sHeightDiff : 0;
    ...
    if (mode === "init") {
      ...
      if (mode === "toggle-sidebar") {
        ...
        if (
          ...
          page.hasClass("header-fixed-top") ||
          page.hasClass("header-fixed-bottom")
        ) {
        ...
        if (
          ...
          if (
            sScrollAlt.length &&
            !sScrollAlt.parent(".slimScrollDiv").length
          ) {
            // If scrolling does not exist init it..
  ...
  var resizePageContent = function () {
    ...
    if (
      header.hasClass("navbar-fixed-top") ||
      header.hasClass("navbar-fixed-bottom") ||
      (sidebarH < windowH && sidebarAltH < windowH)
    ) {
      ...
      if (page.hasClass("footer-fixed")) {
        ...
        pageContent.css(
          "min-height",
          (sidebarH > sidebarAltH ? sidebarH : sidebarAltH) - headerH + "px"
        );
      } else {
        // else if footer is static, remove its height
        pageContent.css(
          "min-height",
          (sidebarH > sidebarAltH ? sidebarH : sidebarAltH) -
            (headerH + footerH) +
            "px"
        );
      }
  ...
  var chatUi = function () {
    ...
    if ($(".chat-talk-messages").length > 0) {
    ...
    $("#sidebar-chat-form").submit(function (e) {
      ...
      if (chatMsg) {
        ...
        chatMessages.append(
          '<li class="chat-talk-msg chat-talk-msg-highlight themed-border animation-slideLeft">' +
  ...
  var templateOptions = function () {
    ...
    if (cookies) {
      themeColorCke = $.cookie("optionThemeColor")
